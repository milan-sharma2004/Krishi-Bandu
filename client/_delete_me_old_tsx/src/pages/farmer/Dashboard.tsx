...
import type { Advisory, CropRecord } from '../../types';

const FORECAST = [
  { label: 'Today', temp: '28°C', sub: 'Partly Cloudy', wind: '8 km/h' },
...
const ADVISORY_ICON: Record<string, React.ElementType> = {
  weather: CloudRain,
  pest: Bug,
  fertilizer: Leaf,
  subsidy: Info,
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm lg:col-span-2">
          ...
          <div className="flex flex-wrap items-center gap-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-3xl font-bold text-gray-900">{FORECAST[0].temp}</p>
                <p className="text-sm text-gray-500">
                  {FORECAST[0].sub} · Wind: {FORECAST[0].wind}
                </p>
              </div>
            </div>
